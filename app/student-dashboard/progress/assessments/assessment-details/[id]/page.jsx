...
export default function AssessmentDetailsPage() {
  ...
  return (
    ...
    >
      ...
      <Grid container spacing={2} justifyContent="center" mb={3} px={{ xs: 1, sm: 3 }}>
          ...
          : pageItems.map((q) => (
              <Grid item xs={12} sm={6} key={q.id}>
                ...
                >
                  ...
                  <Button
                    variant="contained"
                    onClick={() => router.push(`/student-dashboard/progress/assessments/assessment-details/quiz/${q.id}`)}
